...
# STYLING AND FORMATING THE INFORMATION TO MAKE THINGS LOOK NICE NICE
logging.basicConfig(format='%(asctime)s %(levelname)-5s %(message)s', datefmt='%Y-%m-%d %H:%M:%S', level=logging.DEBUG)
logger = logging.getLogger(__name__)

# DEFINING IF ONE OF THE VALUES IS TOO LARGE OR TOO SMALL 
def long2net(arg):
...
# USES THE SCAPY ARP PING FUNCTION TO RETRIEVE INFORMATION 
